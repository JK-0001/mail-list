...
export async function GET(req) {
    try {
        ...
        const gmail = google.gmail({ version: 'v1', auth: oauth2Client });
          ...
          // 1. Get last_synced time from preferences
        ...
        const lastSynced = prefData?.value ? new Date(prefData.value).getTime() : null;
        ...
        const messagesRes = await gmail.users.messages.list({
            userId: "me",
            q: lastSynced ? `after:${Math.floor(lastSynced / 1000)}` : '',
            maxResults: 500,
